...
with open('/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/questions.json', encoding="utf8") as f:
    data = json.load(f)
#print(data)
...
def details(message,email,OTP,user,pswd):
	try:
		...
		msg['Subject'] = 'Regarding CampusPlacement'
...
def window4():
	...
	def showresult(score):
	    ...
	    if score >= 25:
	        img = PhotoImage(file="/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/pics/great1.png")
	        labelimage.configure(image=img)
	        labelimage.image = img
	        labelresulttext.configure(text="You Are Excellent !!")
	    elif (score >= 15 and score < 25):
	        img = PhotoImage(file="/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/pics/justOk.png")
	        labelimage.configure(image=img)
	        labelimage.image = img
	        labelresulttext.configure(text="You Can Be Better and try again !!")
	    else:
	        img = PhotoImage(file="/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/pics/bad.png")
	        labelimage.configure(image=img)
	        labelimage.image = img
	...
	img1 = PhotoImage(file="/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/pics/test.png")
	...
	img2 = PhotoImage(file="/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/pics/start2.png")
...
#----------------------------------MAIN WINDOW------------------------------------------#
win = tk.Tk()
win.title("HeenaSulthan's Window-_-")
...
image = Image.open("/home/student/Desktop/SIMPLE_ONLINE_EXAM-master/pics/Login.jpeg")
